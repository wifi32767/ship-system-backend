...
public class DeviceConverter {
    ...
    public FullDeviceVO Device2FDeviceVO(Device device) {
        return FullDeviceVO.builder()
                .id(device.getDeviceId())
                .deviceName(device.getDeviceName())
                .deviceClass((device.getDeviceClassId() != null) ? new FullDeviceVO.KeyValue(device.getDeviceClassId(), classRepository.getClassNameById(device.getDeviceClassId())) : null)
                .deviceStyle((device.getDeviceStyleId() != null) ? new FullDeviceVO.KeyValue(device.getDeviceStyleId(), classRepository.getStyleNameById(device.getDeviceStyleId())) : null)
                .deviceType((device.getDeviceTypeId() != null) ? new FullDeviceVO.KeyValue(device.getDeviceTypeId(), classRepository.getTypeNameById(device.getDeviceTypeId())) : null)
                .deviceUseYear(device.getDeviceUseYear())
                .devicePrice(device.getDevicePrice())
                .deviceUsingUnit(device.getDeviceUsingUnit())
                .deviceCountry((device.getDeviceCountryId() != null) ? new FullDeviceVO.KeyValue(device.getDeviceCountryId(), countryRepository.getCountryNameById(device.getDeviceCountryId())) : null)
                .deviceLocation(device.getDeviceLocation())
                .deviceLongitude(device.getDeviceLongitude())
                .deviceLatitude(device.getDeviceLatitude())
                .deviceImg(device.getDeviceImg())
